...
# 📰 Wallet Wizard <a name="about-project"></a>

**Wallet Wizard** Wallet Wizard: A Ruby on Rails budget management app with user authentication, category-based expense tracking, and transaction management.
...
```sh
  git clone https://github.com/Amen-Musingarimi/wallet-wizard
  cd wallet-wizard
...
Feel free to check the [issues page](https://github.com/Amen-Musingarimi/wallet-wizard/issues).
...
I would like to thank [ Gregoire Vella](https://www.behance.net/gregoirevella), for the original [design guidelines](https://www.behance.net/gallery/19759151/Snapscan-iOs-design-and-branding?tracking_source=)
